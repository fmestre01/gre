...
public class Saldos {
    ...
    public Saldos(int id, Date data, Double sdo_inicial, Double vlr_repasse, Double vlr_aplicacao, Double vlr_renAplicacao, Double vlr_poupanca, Double sdo_investimentos, Programa programa, Uex uex, Ano ano, Trimestre trimestre, Conta conta) {
        this.id = id;
        this.data = data;
