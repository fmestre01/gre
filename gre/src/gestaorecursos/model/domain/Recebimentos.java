...
public class Recebimentos {
    ...
    public Recebimentos(int id, Date data_entrada, String num_doc, Double vlr_receita, String historico, boolean conciliado, Programa programa, Uex uex, Ano ano, Trimestre trimestre, Conta conta) {
        this.id = id;
    ...
    public String getVlr_receitaFormatado() {
