...
public class SRDeducoesDAO {
    ...
    public SRDeducoesDAO() {
        
        con = ConnectionFactory.getConnection();
        
    }
    
    public boolean inserir(DeducoesSR d) {
        String sql = "INSERT INTO tb_srdeducao(data_deducao, num_doc,historico_deducao,vlr_deducao, id_programa, id_uex, id_ano, id_trimestre) VALUES(?,?,?,?,?,?,?,?)";
    ...
    public boolean alterar(DeducoesSR d) {
        String sql = "UPDATE tb_srdeducao SET data_deducao=?, num_doc=?, historico_deducao=?, vlr_deducao=?, id_programa, id_uex=?, id_ano=?, id_trimestre=? WHERE id=?";
    ...
    public boolean remover(DeducoesSR deducoes) {
        
        String sql = "DELETE FROM tb_srdeducao WHERE id=?";
    ...
    public List<DeducoesSR> listar() throws Exception {
        String sql = "SELECT * FROM tb_srdeducao";
        
        PreparedStatement stmt = null;
        
        ResultSet rs = null;
        
        List<DeducoesSR> deducoess = new ArrayList<>();
