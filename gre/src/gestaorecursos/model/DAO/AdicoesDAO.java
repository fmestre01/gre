...
public class AdicoesDAO {
    ...
    public boolean inserir(Adicoes d) {
        String sql = "INSERT INTO tb_adicoes(data_adicao, num_doc,historico_adicao,vlr_adicao, id_programa, id_uex, id_ano, id_trimestre) VALUES(?,?,?,?,?,?,?,?)";
    ...
    public boolean alterar(Adicoes d) {
        String sql = "UPDATE tb_adicoes SET data_adicao=?, num_doc=?, historico_adicao=?, vlr_adicao=?, id_programa=?, id_uex=?, id_ano=?, id_trimestre=? WHERE id=?";
    ...
    public boolean remover(Adicoes adicoes) {

        String sql = "DELETE FROM tb_adicoes WHERE id=?";
    ...
    public List<Adicoes> listar() throws Exception {
        String sql = "SELECT * FROM tb_adicoes";

        PreparedStatement stmt = null;

        ResultSet rs = null;

        List<Adicoes> adicoess = new ArrayList<>();
