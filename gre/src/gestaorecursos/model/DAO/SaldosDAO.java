...
public class SaldosDAO {
    ...
    public boolean inserir(Saldos s) {
        String sql = "INSERT INTO tb_saldos(data, sdo_inicial,vlr_repasse,vlr_aplicacao,vlr_rendAplicacao,vlr_poupanca,sdo_investimentos,id_conta,id_programa, id_uex, id_ano, id_trimestre) VALUES(?,?,?,?,?,?,?,?,?,?,?,?)";
    ...
    public boolean alterar(Saldos s) {
        String sql = "UPDATE tb_saldos SET data=?, sdo_inicial=?, vlr_repasse=?, vlr_aplicacao=?,vlr_rendAplicacao=?,vlr_poupanca=?,sdo_investimentos=?, id_conta=?, id_programa=?, id_uex=?, id_ano=?, id_trimestre=? WHERE id=?";
    ...
    public boolean remover(Saldos s) {

        String sql = "DELETE FROM tb_saldos WHERE id=?";
    ...
    public List<Saldos> listar() throws Exception {
        String sql = "SELECT * FROM tb_saldos";

        PreparedStatement stmt = null;

        ResultSet rs = null;

        List<Saldos> saldoss = new ArrayList<>();
