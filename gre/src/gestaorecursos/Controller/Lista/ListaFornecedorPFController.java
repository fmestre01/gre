...
import gestaorecursos.Controller.Dialog.FornecedorPfDialogController;
 ...
 * @author mgonc
 */
public class ListaFornecedorPFController implements Initializable {
    ...
    public void carregarTableViewFornecedor() {
        ...
        listFornecedor = fornecedorDAO.listarpf();
    ...
    public void handleBtnAlterar(ActionEvent event) throws IOException {
        ...
        if (fornecedor != null) {
            boolean buttonConfirmarClicked = showFornecedorPfDialog(fornecedor);
    ...
    public boolean showFornecedorPfDialog(Fornecedor fornecedor) throws IOException {
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(FornecedorPfDialogController.class.getResource("/gestaorecursos/views/fornecedor/FornecedorPfDialog.fxml"));
        AnchorPane page = (AnchorPane) loader.load();

        // Criando um Estágio de Diálogo (Stage Dialog)
        Stage dialogStage = new Stage();
        dialogStage.setTitle("Cadastro de Fornecedores PF");
        Scene scene = new Scene(page);
        dialogStage.setScene(scene);

        // Setando o cliente no Controller.
        FornecedorPfDialogController controller = loader.getController();
