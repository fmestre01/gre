...
import gestaorecursos.model.DAO.AdicoesDAO;
 ...
 * @author mgonc
 */
public class AdicoesDialogController implements Initializable {
    ...
    private final AdicoesDAO adicoesDao = new AdicoesDAO();
    ...
    public Adicoes getAdicoes() {
        return adicoes;
    }

    public void setAdicoes(Adicoes adicoes) {
