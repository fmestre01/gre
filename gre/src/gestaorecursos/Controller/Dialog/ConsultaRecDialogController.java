 ...
 * @author mgonc
 */
public class ConsultaRecDialogController implements Initializable {

    @FXML
    private Stage dialogStage;
    private boolean butonConfirmarClicked = false;
    private Recebimentos r;
    ...
    public boolean isButonConfirmarClicked() {
        return butonConfirmarClicked;
    }

    public void setButonConfirmarClicked(boolean butonConfirmarClicked) {
        this.butonConfirmarClicked = butonConfirmarClicked;
    }

    public Recebimentos getR() {
        return r;
    }

    public void setR(Recebimentos r) {
        this.r = r;
        this.cbxPrograma.setValue(r.getPrograma());
        this.cbxUex.setValue(r.getUex());
        this.cbxAno.setValue(r.getAno());
        this.cbxTrimestre.setValue(r.getTrimestre());
        this.cbxDadosBancarios.setValue(r.getConta());
        
        this.txtFieldNumDoc.setText(r.getNum_doc());
        this.txtFieldValor.setText(r.getVlr_receitaFormatado());
        this.txtFieldHistorico.setText(r.getHistorico());
        
        //DatePicker
        this.inputData.setValue(ConversorData.converter(r.getData_entrada()));
  }
