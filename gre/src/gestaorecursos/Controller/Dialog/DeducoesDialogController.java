...
import gestaorecursos.model.DAO.DeducoesDAO;
 ...
 * @author mgonc
 */
public class DeducoesDialogController implements Initializable {
    ...
    private final DeducoesDAO deducoesDao = new DeducoesDAO();
    ...
    public Deducoes getDeducoes() {
        return deducoes;
    }

    public void setDeducoes(Deducoes deducoes) {
