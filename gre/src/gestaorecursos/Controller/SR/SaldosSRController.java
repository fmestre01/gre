...
import gestaorecursos.model.DAO.SRSaldosDAO;
 ...
 * @author mgonc
 */
public class SaldosSRController implements Initializable {
    ...
    private final SRSaldosDAO srsaldosDAO = new SRSaldosDAO();
    ...
    public SaldosSR getSaldosSR() {
        return saldosSR;
    }

    public void setSaldosSR(SaldosSR saldosSR) {
        this.saldosSR = saldosSR;
    }
