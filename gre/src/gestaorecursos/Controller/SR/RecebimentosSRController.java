...
import gestaorecursos.model.DAO.SRRecebimentosDAO;
 ...
 * @author mgonc
 */
public class RecebimentosSRController implements Initializable {
    ...
    private RecebimentosSR recebimentosSR;
    ...
    private final SRRecebimentosDAO srrecebimentosDAO = new SRRecebimentosDAO();
    ...
    public RecebimentosSR getRecebimentosSR() {
        return recebimentosSR;
    }

    public void setRecebimentosSR(RecebimentosSR recebimentosSR) {
        this.recebimentosSR = recebimentosSR;
    }

    public void handleBtnConfirmar() throws IOException, SQLException, Exception {
        RecebimentosSR a = new RecebimentosSR();
